...
void Mutation(const Population *pop, Population *new_pop, int num_cds, const int *amino_seq_idx, int len_amino_seq, float mprob)
{
...
int main()
{
	...
	const char *ff_result[] = {
		"/home/jeus5771/CPU_protein/My_NSGA2/My_NSGA2_result/My_NSGA2_result1.csv",
		"/home/jeus5771/CPU_protein/My_NSGA2/My_NSGA2_result/My_NSGA2_result2.csv",
		"/home/jeus5771/CPU_protein/My_NSGA2/My_NSGA2_result/My_NSGA2_result3.csv",
		"/home/jeus5771/CPU_protein/My_NSGA2/My_NSGA2_result/My_NSGA2_result4.csv",
		"/home/jeus5771/CPU_protein/My_NSGA2/My_NSGA2_result/My_NSGA2_result5.csv",
		"/home/jeus5771/CPU_protein/My_NSGA2/My_NSGA2_result/My_NSGA2_result6.csv"};
	...
	for (int zz = 0; zz < sizeof(ff_cds_num) / sizeof(int); zz++)
	{
		...
		for (int z = 0; z < global_cycle; z++)
		{
			...
			for (int cycle = 0; cycle < max_cycle; cycle++)
			{
				for (int i = 0; i < colony_size; i++)
				{
					Mutation(&pop[i], &pop[i + colony_size], num_cds, amino_seq_idx, len_amino_seq, mprob);
					/* Calculate Objective Functions */
					mCAI(&pop[i + colony_size], num_cds, amino_seq_idx, len_amino_seq);
					mHD(&pop[i + colony_size], num_cds, len_amino_seq);
					MLRCS(&pop[i + colony_size], num_cds, len_amino_seq);
				}
			...
			{
				pop[i].sol.obj_val[_mHD] = pop[i].sol.obj_val[_mHD] / 0.4;
			}
